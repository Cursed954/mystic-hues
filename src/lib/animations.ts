...
export const breathingGlow = (color: string = "rgba(255,126,17,0.5)") => ({
  boxShadow: [
...
export const letterAnimation = (delay: number = 0): Variants => {
  return {
    hidden: {
      opacity: 0,
      y: 50,
...
export const revealFromLeft = (delay: number = 0): Variants => {
  return {
    hidden: {
      x: -100,
      opacity: 0
...
export const revealFromRight = (delay: number = 0): Variants => {
  return {
    hidden: {
      x: 100,
      opacity: 0
...
// Enhanced 3D effect animation
export const reveal3D = (delay: number = 0): Variants => {
  return {
    hidden: {
      opacity: 0,
      rotateX: 80,
